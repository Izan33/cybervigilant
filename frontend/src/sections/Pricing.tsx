    ...
    <section className="py-24">
      <div className="container mx-auto">
        <h2 className="section-title">
          Tarifs et Abonnements - Sécurisez votre entreprise contre les cybermenaces
        </h2>
        <p className="section-description mt-5">
          Choisissez la meilleure solution de cybersécurité pour protéger vos données, garantir votre conformité et anticiper les menaces numériques.
        </p>
            ...
            >
              <div className="flex justify-between">
                ...
                {popular === true && (
                  <div className="inline-flex text-sm px-4 py-1.5 rounded-xl border border-white/20">
                    <span className="bg-[linear-gradient(to_right,#DD7DDF,#E1CD8,#BBCB92,#71C2EF,#3BFFFF,#DD7DDF)] bg-clip-text font-medium">
                      Populaire
                    </span>
                  </div>
                )}
              ...
              <ul className="flex flex-col gap-5 mt-8">
                {features.map((feature, index) => (
                  <li key={`${title}-${index}`} className="text-sm flex items-center gap-4">
